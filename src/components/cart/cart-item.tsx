...
export default function CartItem({
  ...
  return (
    ...
    >
      ...
      <button
        className="flex h-min !max-w-[40px] grow items-center justify-center rounded-xl bg-neutral-100 p-2 text-black transition-all hover:bg-red-500/25 hover:text-red-500"
