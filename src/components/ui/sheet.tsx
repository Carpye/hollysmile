...
export const OpenSheet = ({
  ...
  return (
    <Sheet>
      ...
      <SheetContent side={"right"} className="!max-w-[500px] bg-white">
        <SheetHeader>
          <SheetTitle>{header}</SheetTitle>
        </SheetHeader>
        <div className="flex h-full flex-col justify-between gap-4 py-12">
          {children}
          <SheetClose asChild>{closeTrigger}</SheetClose>
        </div>
      </SheetContent>
    </Sheet>
  )
